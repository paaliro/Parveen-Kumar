    ...
    return (
        <section ref={sectionRef} className="sm:flex justify-center mx-8 mt-8 vw-100 bg-[#202123] rounded-2xl py-4 md:py-8">
            <div ref={image1Ref} className="sm:flex flex-col justify-center mb-4 sm:mb-0 sm:w-7/12">
                <ImageTag src="/images/sections/showCase/img-1.png" alt="showCase-img-1" className="flex justify-center w-100 md:w-full mx-auto" />
            ...
            <div className="flex flex-col gap-6">
                <div ref={image2Ref} className="mt-5">
                    <ImageTag src="/images/sections/showCase/img-2.png" alt="showCase-img-2" className="w-100 md:w-full mx-auto" />
                    <h1 className="font-semibold text-lg sm:text-xl mt-1 ml-2 text-center">The Library Management Platform</h1>
                </div>
                <div ref={image3Ref} >
                    <ImageTag src="/images/sections/showCase/img-3.png" alt="showCase-img-3" className="w-100 md:w-full mx-auto" />
